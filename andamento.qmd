...
dados1_tipos_de_variaveis <- read_excel("banco_dados/dados1_tipos_de_variaveis.xlsx", 
    sheet = "Planilha1")
```

[<i class="fa-solid fa-download"></i> Baixar dados1_tipos_de_variaveis.xlsx](banco _dados/dados1_tipos_de_variaveis.xlsx){.btn .btn-light download="dados1_tipos_de_variaveis.xlsx"}
