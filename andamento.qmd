...
[<i class="fa-solid fa-download"></i> Baixar dados1_tipos_de_variaveis.xlsx](banco_dados/dados1_tipos_de_variaveis.xlsx){.btn .btn-light download="dados1_tipos_de_variaveis.xlsx"}
